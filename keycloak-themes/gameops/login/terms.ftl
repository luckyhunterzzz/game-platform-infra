    ...
    <div id="kc-terms-text">
      ...
      <div class="${properties.kcFormGroupClass!}" style="margin-top: 1rem;">
        <ul style="margin: 0; padding-left: 1.25rem;">
          <li>
            <a href="https://gameops-platform.dev/privacy" target="_blank" rel="noopener noreferrer">
              ${msg("privacyPolicyLabel")}
            </a>
          </li>
          <li>
            <a href="https://gameops-platform.dev/terms" target="_blank" rel="noopener noreferrer">
              ${msg("termsOfUseLabel")}
            </a>
          </li>
        </ul>
